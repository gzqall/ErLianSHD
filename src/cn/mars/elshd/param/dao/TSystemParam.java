...
/**
 * 数据表[t_system_param]的处理类
 * @author Administrator
 *
 */
@Table(
	tableName="t_system_param", sortName="elshd", database="elshd", check=false, backup=false, checkTime=30, description="系统参数表",
	primaryKey=@PrimaryKey( name="t_system_param_pk", columns="param_id" ),
	columns={
		@Column( name="param_id", description="参数编号", dataType=Column.DATATYPE.VARCHAR, length=24, notNull=true ),
		@Column( name="param_value", description="参数值", dataType=Column.DATATYPE.VARCHAR, length=24, notNull=true ),
...
public class TSystemParam extends BaseTable
{
	 ...
	 */
	@Rowset(
		columns="param_value, param_id, bk_number1, bk_number2, bk_value1, bk_value2, bk_type1, bk_type2, bk_flag1, bk_flag2, bk_date1, bk_date2, bk_time1, bk_time2, bk_s_str1, bk_s_str2, bk_l_str1, bk_l_str2, bk_xl_str1, bk_xl_str2, memo, dac", maxRecord="10", description="多记录查询",
		filter={
	 ...
	 */
	@Select(
		columns="param_id,param_value,bk_number1,bk_number2,bk_value1,bk_value2,bk_type1,bk_type2,bk_flag1,bk_flag2,bk_date1,bk_date2,bk_time1,bk_time2,bk_s_str1,bk_s_str2,bk_l_str1,bk_l_str2,bk_xl_str1,bk_xl_str2,memo,dac", description="单记录查询",
		filter={
			@Filter( columnName="param_id", operator=Filter.OPTYPE.EQ )
		}
	)
	 ...
	 */
	@Insert(
		columns="param_id,param_value,bk_number1,bk_number2,bk_value1,bk_value2,bk_type1,bk_type2,bk_flag1,bk_flag2,bk_date1,bk_date2,bk_time1,bk_time2,bk_s_str1,bk_s_str2,bk_l_str1,bk_l_str2,bk_xl_str1,bk_xl_str2,memo,dac", description="插入记录"
	)
	 ...
	 */
	@Update(
		columns="param_value,bk_number1,bk_number2,bk_value1,bk_value2,bk_type1,bk_type2,bk_flag1,bk_flag2,bk_date1,bk_date2,bk_time1,bk_time2,bk_s_str1,bk_s_str2,bk_l_str1,bk_l_str2,bk_xl_str1,bk_xl_str2,memo,dac", description="修改记录",
		filter={
			@Filter( columnName="param_id", operator=Filter.OPTYPE.EQ )
		}
	)
	 ...
	 */
	@Update(
			columns="bk_flag2", description="锁定数据",
			filter={
					@Filter( columnName="param_id", operator=Filter.OPTYPE.EQ )
			}
	)
     ...
     */
    @Update(
            columns="param_value", description="锁定数据",
            filter={
                    @Filter( columnName="param_id", operator=Filter.OPTYPE.EQ )
            }
    )
