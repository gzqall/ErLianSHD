...
<rocket:body>
<rocket:title caption="增加报关单信息"/>
<rocket:errors/>

<rocket:form action="/txn01B01013">
  <rocket:block property="record" caption="增加报关单信息" width="95%">
      <rocket:button name="record_saveRecord" caption="保 存" hotkey="SAVE" onclick="func_record_saveRecord();"/>
      <rocket:button name="record_saveAndContinue" caption="保存并继续" hotkey="SAVE_CONTINUE" onclick="func_record_saveAndContinue();"/>
      <rocket:button name="record_saveAndExit" caption="保存并关闭" hotkey="SAVE_CLOSE" onclick="func_record_saveAndExit();"/>
      <rocket:button name="record_goBack" caption="返 回" hotkey="CLOSE" onclick="func_record_goBack();"/>
      <rocket:text property="bill_id" caption="审核单号" datatype="string" maxlength="24" minlength="1" style="width:95%"/>
      <rocket:text property="index_no" caption="索引号" datatype="string" maxlength="10" minlength="1" style="width:95%"/>
