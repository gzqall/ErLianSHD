...
Body{
	...
	margin:0px auto;
	padding:0px;
	background-image:url(script/login_new/red/BodyBG.gif);
	font-size:12px;
	scrollbar-face-color: #EFE6DF;
	scrollbar-shadow-color: #D4CAC2;
	scrollbar-highlight-color: #FFFFFF;
	scrollbar-3dlight-color: #D4CAC2;
	scrollbar-darkshadow-color: #F4F1EE;
	scrollbar-track-color: #EFEAE6;
	scrollbar-arrow-color: #5F2E01;
}
/*-------------------Login-------------------*/
...
html>body .LoginSPARK_BodyLogo_new{
	background-image:url(script/login_new/red/loginSPARK_03.png);
}

* .LoginSPARK_BodyLogo_new{
	width:975px;
	height:120px;
	filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='script/login_new/red/loginSPARK_03.png');
}
...
html>body .LoginSPARK_BodyInput_left{	
	background-image:url(script/login_new/red/loginSPARK_05.png);
	}
* .LoginSPARK_BodyInput_left{
	filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='script/login_new/red/loginSPARK_05.png');
	}
.LoginSPARK_BodyInput_Pic{
	width:458px;
	height:127px;
	background-repeat:no-repeat;
	background-image:url(script/login_new/red/loginSPARK_06.png);
	float:left;
	}
.LoginSPARK_BodyInput_Input{
	...
	height:127px;
	background-repeat:no-repeat;
	background-image:url(script/login_new/red/loginSPARK_07.png);
	float:left;
	}
...
html>body .LoginSPARK_BodyInput_right{	
	background-image:url(script/login_new/red/loginSPARK_09.png);
	}
* .LoginSPARK_BodyInput_right{
	filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='script/login_new/red/loginSPARK_09.png');
	}
...
html>body .LoginSPARK_BodyBotton{
	background-image:url(script/login_new/red/loginSPARK_10.png);
}

* .LoginSPARK_BodyBotton{
	width:975px;
	height:120px;
	filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(src='script/login_new/red/loginSPARK_10.png');
}
...
<%
/*
<head><title>欢迎使用spark业务平台</title></head>
*/
%>
...
<div class="LoginSPARK_container">
	<div class="LoginSPARK_BodyLogo_new">
	  ...
	  <td align="left">
		  <div style="width:400; padding-left:0; padding-top:40; color:#911600; font-family:黑体; font-size:20px; filter: Alpha(Opacity=70);" >
			  <b><%=AppTitle%></b>
		  </div>
	  </td>
  </tr>
				...
				<table>
					...
					<td>
						...
						<div style="width:100; float:left; padding-left:0; padding-top:0" align="left">
						   <input type='hidden' id='_name' name='_name'>
							<div class='browse-input' style='display:inline;width:95%' onclick='selectUserName("username")'><div class='box'><input type='text' haveButton='true' _width='100%' name='username' id='username'  maxlength="24" size="15" value='' checkFlag='true' notnull='true' minvalue='1' maxvalue='24' datatype='string' style="color:#911600; ime-mode:inactive" class="text"></div></div>
					   </div>
					</td>
					</tr>
					<tr>
					<td>
						...
						<div style="width:95; float:left; padding-left:0" align="left">
							<div style="width:95; float:left; padding-left:0" align="left">
								<input type='password' name='password' id='password' size="15" value='' checkFlag='true' notnull='true' minvalue='1' datatype='password' style="color:#911600; width:100%;ime-mode:disabled">
						   </div>
					...
					<td>
						...
						<div style="width:95; float:left; padding-left:0" align="left">
							<div style="width:95; float:left; padding-left:0" align="left">
								<input type='text' _width='100%' name='add-code' id='add-code'  maxlength="4" value='' checkFlag='true' notnull='true' minvalue='4' maxvalue='4' datatype='string' style="color:#911600;ime-mode:disabled;width:50px" class="text">
						   </div>
	...
	<div class="LoginSPARK_BodyInput_button"><input name="imageField" type="image" src="script/login_new/red/loginSPARK_08.png"  onMouseOver="this.src='script/login_new/red/loginSPARK_08_2.png'" onMouseOut="this.src='script/login_new/red/loginSPARK_08.png'" border="0" onclick="_saveUserName()"></div>
